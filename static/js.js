...
var canvas = document.getElementById("rayTraceReflectionCanvas");
...
var sphere1 = new Sphere(new Vector3(-10, 20, -10), 10);
var sphere2 = new Sphere(new Vector3(10, 20, -10), 10);
var sphere3 = new Sphere(new Vector3(0, 10, -10), 10);
var sphere4 = new Sphere(new Vector3(3, 12, 2), 1);
var sphere5 = new Sphere(new Vector3(-3, 12, 2), 1);
var sphere6 = new Sphere(new Vector3(0, 7, 2), 3);
...
sphere4.material = new PhongMaterial(Color.black, Color.white, 16, 0.25);
sphere5.material = new PhongMaterial(Color.black, Color.white, 16, 0.25);
sphere6.material = new PhongMaterial(Color.white, Color.white, 16, 0.25);

rayTraceReflection(
    document.getElementById('rayTraceReflectionCanvas'),
    new Union([plane, sphere1, sphere2,sphere3,sphere4,sphere5,sphere6]),
    new PerspectiveCamera(new Vector3(0, 10, 15), new Vector3(0, 0, -1), new Vector3(0, 1, 0), 90),
    3);
